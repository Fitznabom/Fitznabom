...
Меня зовут Иван, я начинающий QA Engineer. Понимаю принципы тестирования ПО, знаком с основными видами и уровнями тестирования. Умею составлять тест‑кейсы, чек‑листы и баг‑репорты по стандартам. Практиковался в проверке веб‑форм, тестировании API через Postman и анализе логов. Знаю основы SQL для простых запросов к БД. Стремлюсь попасть в команду, где смогу применить базовые навыки и быстро расти под руководством опытных коллег.
